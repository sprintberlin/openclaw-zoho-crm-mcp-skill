## Description: <br>
Connects an agent to Zoho CRM through MCP so it can search contacts, list accounts, read and update records, optionally query records with COQL, and use mcporter-based helper scripts for common CRM operations. <br>
...
## Use Case: <br>
Developers and CRM operators use this skill to connect an agent to Zoho CRM via MCP, configure the required MCP endpoint, search CRM modules, list contacts and accounts, and run optional COQL queries through mcporter. <br>
